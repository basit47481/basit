				...
				<div class="logo-area">
					<div class="site-branding">
						...
						if(!empty(is_array($rezillaMeta) && array_key_exists('rezilla_meta_select_logo', $rezillaMeta)) && $rezillaMeta['rezilla_meta_select_logo'] == true && !empty($rezillaMeta['rezilla_meta_logo']['url'])){
							...
							$rezilla_ShowLogo = rezilla_options('rezilla_show_hlogo3');
							$rezilla_logo = rezilla_options('rezilla_logo3');
				...
				<div class="navbar-collapse nav-menu stellarnav">
					...
					wp_nav_menu(
						array(
							...
							'menu_id'        	=> 'mainmenu',
							'menu_class'		=> 'navbar-nav ms-0 me-auto',
							'echo'              => true,
                            'fallback_cb'       => 'rezilla_Nav_Walker::fallback',
                            'walker'            => new rezilla_Nav_Walker
						)
					);
					if( '1' == rezilla_options('rezilla_header_enable_search') ){
						get_template_part('inc/header/search','button'); 
					}
					if( '1' == rezilla_options('rezilla_header_enable_cta') ){
